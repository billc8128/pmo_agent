        ...
        <div className="mt-2 grid gap-4 md:grid-cols-[minmax(0,1fr)_18rem]">
          ...
          <div className="rounded-md border border-zinc-200 bg-zinc-50 p-3 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-400">
            ...
            <p className="mt-1 leading-relaxed">
              ...
              can connect repos by URL; provider secrets stay in the bot
              deployment and are never shown here.
            </p>
          </div>
        </div>
      </header>
        ...
        <div>
          <div className="mb-3 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-500">
                Repositories connected to the PMO agent as shared event sources.
              </p>
            </div>
      ...
      <div className="mt-3">
        {provider.installUrl && (
          <a
            ...
            className="mb-2 inline-flex rounded bg-zinc-900 px-3 py-1.5 text-xs font-medium text-white transition hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
          >
            Install GitHub App
          </a>
        )}
...
function AddRepoPanel({
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
        Paste a repo URL. The PMO agent will use it as a shared source for
        proactive rules; webhook secrets stay in the bot deployment.
      </p>
      ...
      <p className="mt-3 text-xs leading-relaxed text-zinc-500 dark:text-zinc-500">
        Saving the same provider/repo again refreshes the mapping. After this,
        copy the provider webhook URL above into the repo settings and send a
        test delivery.
      </p>
    </form>
  );
